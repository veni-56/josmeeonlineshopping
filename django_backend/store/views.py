...
def search_api(request):
    """API endpoint for product search with JSON response"""
...
def products_api(request):
    items = [
        {"id": 1, "name": "Premium Jaggery 500g", "price": 6.50},
        {"id": 2, "name": "Natural Candy 250g", "price": 3.80},
        {"id": 3, "name": "Organic Syrup 300ml", "price": 5.20},
    ]
