...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('document_type', models.CharField(choices=[('pan', 'PAN Card'), ('gst', 'GST Certificate'), ('business_license', 'Business License'), ('other', 'Other')], max_length=20)),
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='seller_documents', to=settings.AUTH_USER_MODEL)),
            ],
            options={
