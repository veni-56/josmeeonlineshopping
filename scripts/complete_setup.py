...
def create_sample_data():
    ...
    try:
        ...
        if not User.objects.filter(username='seller1').exists():
            ...
            # Create categories
            cat1 = Category.objects.create(name='Premium Products', slug='premium-products')
            cat2 = Category.objects.create(name='Organic Products', slug='organic-products')
            cat3 = Category.objects.create(name='Traditional Items', slug='traditional-items')
            ...
            Product.objects.create(
                ...
                name='Premium Blocks',
                slug='premium-blocks',
                description='Traditional premium blocks made from pure natural sap.',
                price=250,
                stock=100,
                category=cat1,
                is_active=True
            ...
            Product.objects.create(
                ...
                name='Organic Powder',
                slug='organic-powder',
                description='Finely ground organic powder, perfect for beverages.',
                price=200,
                stock=150,
                category=cat2,
                is_active=True
            ...
            print("    - Shop: Traditional Premium Store")
...
def main():
    """Main setup function"""
    print("=" * 70)
    print("JOSMEE ONLINE SHOPPING - COMPLETE DATABASE SETUP")
    print("=" * 70)
    ...
    print("=" * 70)
    print("\nYour Josmee Online Shopping is ready to use!")
